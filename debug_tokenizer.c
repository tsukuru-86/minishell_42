...
void	print_token_type(t_token_type type)
{
	switch (type)
	{
		...
		case TOKEN_SINGLE_QUOTE: printf("S_QUOTE"); break;
		case TOKEN_DOUBLE_QUOTE: printf("D_QUOTE"); break;
		case TOKEN_S_QUOTED_WORD: printf("S_QUOTED_WORD"); break;
		case TOKEN_D_QUOTED_WORD: printf("D_QUOTED_WORD"); break;
